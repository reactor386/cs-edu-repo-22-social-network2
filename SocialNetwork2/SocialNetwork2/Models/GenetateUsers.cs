...
{
    public readonly string[] maleNames = [
        "Александр", "Борис", "Василий", "Игорь", "Даниил",
        "Сергей", "Евгений", "Алексей", "Геогрий", "Валентин"
        ];
    public readonly string[] femaleNames = [
        "Анна", "Сюзанна", "Мария", "Станислава", "Елена"
        ];
    public readonly string[] lastNames = [
        "Гагарин", "Титов", "Леонов", "Джанибеков", "Волков"
        ];
    ...
    public List<User> Populate(int count)
    {
        ...
        for (int i = 1; i <= count; i++)
        {
            ...
            var item = new User()
            {
                FirstName = firstName,
                LastName = lastName,
                BirthDate = DateTime.Now.AddDays(
                    -rand.Next(1, (DateTime.Now - DateTime.Now.AddYears(-25)).Days)),
